...
//    @Test
//    fun shouldFindNearbyShort() {
//        val meter = MultiMeter()
//        val circuit = CircuitBoard(
//            mapOf(
//                "red" to listOf("R5", "U5"),
//                "green" to listOf("U5", "R5")
//            )
//        )
//
//        val shortedPin = meter.findShortedPin(circuit)
//        assertEquals(Pin(5, 5), shortedPin)
//    }
//
//    @Test
//    fun shouldFindNearbyShortNotInPin() {
//        val meter = MultiMeter()
//        val circuit = CircuitBoard(
//            mapOf(
//                "red" to listOf("R5", "U5"),
...
//
//    @Test
//    fun shouldFindNearbyShortInBoard() {
//        val meter = MultiMeter()
//        val circuit = CircuitBoard(
//            mapOf(
//                "red" to listOf("L3", "D5"),
//                "green" to listOf("U5", "R5", "D10", "L8")
//            )
//        )
//
//        val shortedPin = meter.findShortedPin(circuit)
//        assertEquals(Pin(-3, -5), shortedPin)
//    }
//
//    @Test
//    fun shouldExcludeSelfShortsFromWires() {
//        val meter = MultiMeter()
//        val circuit = CircuitBoard(
//            mapOf(
//                "red" to listOf("U15", "L10", "D10", "R20"),
//                "green" to listOf("R10", "U5")
//            )
//        )
//
//        val shortedPin = meter.findShortedPin(circuit)
//        assertEquals(Pin(10, 5), shortedPin)
//    }
//
//
//    @Test
//    fun shouldFindDIstanceForShort() {
//        val meter = MultiMeter()
//        val circuit = CircuitBoard(
//            mapOf(
//                "red" to listOf("L3", "D5"),
...
//
//        val shortedPin = meter.findShortedPin(circuit)
//        val distance = meter.distanceToPin(shortedPin)
//        assertEquals(8, distance)
//    }
//
//    @Test
//    fun shouldFinDistance() {
//        val meter = MultiMeter()
//        val circuit = CircuitBoard(
//            mapOf(
//                "red" to listOf("R75", "D30", "R83", "U83", "L12", "D49", "R71", "U7", "L72"),
//                "green" to listOf("U62", "R66", "U55", "R34", "D71", "R55", "D58", "R83")
//            )
//        )
//
//        val shortedPin = meter.findShortedPin(circuit)
...
//
//    @Test
//    fun shouldFindShortedWIthLeastDelay() {
//        val meter = MultiMeter()
//        val circuit = CircuitBoard(
//            mapOf(
//                "red" to listOf("R8", "U5", "L5", "D3"),
//                "green" to listOf("U7", "R6", "D4", "L4")
//            )
//        )
//
//        val shortedPin = meter.findShortedPinWithMinimalDelay(circuit)
//        assertEquals(30, shortedPin.second)
//    }
//
//    @Test
//    fun shouldFindShortedWIthLeastDelay2() {
//        val meter = MultiMeter()
//        val circuit = CircuitBoard(
//            mapOf(
//                "red" to listOf("R75", "D30", "R83", "U83", "L12", "D49", "R71", "U7", "L72"),
...
//
//        val shortedPin = meter.findShortedPinWithMinimalDelay(circuit)
//        assertEquals(610, shortedPin.second)
//    }
//
//    @Test
//    fun shouldFindShortedWIthLeastDelay3() {
//        val meter = MultiMeter()
//        val circuit = CircuitBoard(
//            mapOf(
//                "red" to listOf("R98", "U47", "R26", "D63", "R33", "U87", "L62", "D20", "R33", "U53", "R51"),
//                "green" to listOf("U98", "R91", "D20", "R16", "D67", "R40", "U7", "R15", "U6", "R7")
//            )
//        )
//
//        val shortedPin = meter.findShortedPinWithMinimalDelay(circuit)
//        assertEquals(410, shortedPin.second)
//    }

    @Test
    fun shouldIncludeSelfShortInWires2() {
        val meter = MultiMeter()
        val circuit = CircuitBoard(
            mapOf(
                "red" to listOf("U15", "L10", "D10", "R20"),
